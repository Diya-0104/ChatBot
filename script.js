const API_KEY = "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";
...
async function fetchGroqData(messages) {
  try {
    const response = await fetch(API_URL, {
      method: "POST",
      headers: {
        Authorization: `Bearer ${API_KEY}`,// Corrected this line
...
appendMessage("");  // This is fine, as it just clears or initializes the chat.